...
export function EditJobForm() {
  ...
  if (form.loadStatus === "error") {
    return (
      <Card title={t.jobs.edit.title}>
        <p>{form.notFound ? t.jobs.details.notFound : t.jobs.edit.loadFailed}</p>
        {!form.notFound ? (
  ...
  return (
    <>
      <Card title={t.jobs.edit.title} description={t.jobs.edit.description}>
        <Form
          onSubmit={(event) => {
        ...
        >
          ...
          >
            <Input
              ...
              onBlur={(event) => form.validateField("title", event.target.value)}
            />
          </FormField>
          ...
          <div className="settings-actions">
            ...
            <LoadingButton
              ...
              loadingLabel={t.jobs.edit.saving}
